        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    ...
                    <h3 class="text-center my-4">Viewing FYPs</h3>
                    <header class="d-flex justify-content-center py-3">
                        <ul class="nav nav-pills">
                          ...
                          <li class="nav-item"><a href="{{ route('fyps.index') }}" class="nav-link link-dark" style="font-weight: 600">FYPs</a></li>
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('fyps.create') }}" class="btn btn-md btn-success mb-3">ADD FYP</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Are you sure?');" action="{{ route('fyps.destroy', $fyp->id) }}" method="POST">
                                                <a href="{{ route('fyps.show', $fyp->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                                <a href="{{ route('fyps.edit', $fyp->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                @csrf
                                                @method('DELETE')
