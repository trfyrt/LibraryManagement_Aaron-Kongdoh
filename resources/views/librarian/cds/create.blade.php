                    ...
                    <div class="card-body">
                        <form action="{{ route('cds.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('genre') is-invalid @enderror" name="genre" value="{{ old('genre') }}" placeholder="Enter Genre">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('stock') is-invalid @enderror" name="stock" value="{{ old('stock') }}" placeholder="Enter Stock">
